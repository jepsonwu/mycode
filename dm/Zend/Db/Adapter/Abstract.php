...
abstract class Zend_Db_Adapter_Abstract
{
    ...
    public function query($sql, $bind = array())
    {
        ...
        if ($this->isSlaveDB()){
            ...
            if (in_array($action, array('INSERT', 'DELETE', 'UPDATE'))){
                throw new Zend_Db_Adapter_Exception("Salve db is not allowed to insert/update/delete. SQL: ".$sql);
            }
        }
    ...
    private function isSlaveDB()
    {
        if (isset($this->_config['role']) && $this->_config['role']=='slave'){
            return true;
        }else{
            return false;
        }
    ...
    public function beginTransaction()
    {
        //从库禁止启用事务
        if ($this->isSlaveDB()){
            throw new Zend_Db_Adapter_Exception("Salve db is not allowed to use beginTransaction CALL.");
        }
