...
class DM_Module_Log {
	 ...
	 * $type:添加类型，1覆盖，2追加
	 */
	public static function addLogs($content,$filename=null,$type=2,$filetype='log',$path=null){
		$filePath = APPLICATION_PATH.'/data/log/';
		!empty($path) && $filePath .= $path;
		empty($filename) && $filename = date("YmdHis");
