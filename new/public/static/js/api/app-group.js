            ...
            if(isChrome){
                if(info.os.android){
                    if(rUa.match(/360\s{0,10}aphone\s{0,10}browser/i)){
                        loadIframe.src="caizhu://caizhu/groupInfo?id="+groupID;
                    }else{
                        window.location.href = 'intent://caizhu/groupInfo?id=' + groupID + '#Intent;scheme=caizhu;package=com.caizhu.caizhu;end';
                    }
                }else{
                    window.location.href = 'caizhu://caizhu/groupInfo?id='+groupID;
                }
            }else{
