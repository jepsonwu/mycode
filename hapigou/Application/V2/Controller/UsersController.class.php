...
class UsersController extends CommonController
{
	...
	protected $user_get_html_conf = array(
		...
		"check_fields" => array(
			...
			array("fields",
				"mobile,name,gender,avatar,location,nationality,introduce,status,token,create_time,type",
				null, 0, "in",
	...
	public function user_get_html()
	{
		...
		if ($result) {
			...
			if ($result['type'] == self::TEACHER) {
				//通话总时长
				$called_time = M("TeacherCalledTime")->where("tid='" . USER_ID . "'")->getField("called_time");
